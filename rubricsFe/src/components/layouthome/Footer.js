  ...
  return (
    ...
    <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
      ...
      <div className="text-center">
        <Link to="#" className="flex items-center  mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
          {/* <img src="./images/logo.svg" className="h-6 mr-3 sm:h-9" alt="Landwind Logo" /> */}
          RubRics    
        </Link>
        <span className="block text-sm text-left text-gray-500 dark:text-gray-400">© 2024 Rubrics.
        </span>
